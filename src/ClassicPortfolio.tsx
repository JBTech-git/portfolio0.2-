...
function Hero() {
  ...
  return (
    <Section id="home" className="relative overflow-hidden min-h-0 py-16 sm:py-20 md:py-24 lg:py-28 flex items-center">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10 depth-grid opacity-60" />

      {/* Floating code panels — desktop */}
      <div className="pointer-events-none absolute inset-0 hidden lg:block" aria-hidden>
        <div className="float-panel glass-panel absolute left-[2%] top-[18%] w-[180px] rounded-xl p-3 text-left opacity-80">
          <div className="mb-2 flex gap-1.5">
            <span className="h-2 w-2 rounded-full bg-rose-400/80" />
            <span className="h-2 w-2 rounded-full bg-amber-400/80" />
            <span className="h-2 w-2 rounded-full bg-emerald-400/80" />
          </div>
          <pre className="font-mono text-[10px] leading-relaxed text-cyan-200/90">{`const app = {\n  stack: "React",\n  ship: true\n}`}</pre>
        </div>
        <div className="float-panel-alt float-panel-delay glass-panel absolute right-[3%] top-[22%] w-[170px] rounded-xl p-3 text-left opacity-75">
          <div className="mb-2 flex gap-1.5">
            <span className="h-2 w-2 rounded-full bg-rose-400/80" />
            <span className="h-2 w-2 rounded-full bg-amber-400/80" />
            <span className="h-2 w-2 rounded-full bg-emerald-400/80" />
          </div>
          <pre className="font-mono text-[10px] leading-relaxed text-fuchsia-200/90">{`POST /api/v1\n→ 200 OK\nlatency: 42ms`}</pre>
        </div>
        <div className="float-panel glass-panel absolute bottom-[14%] left-[8%] w-[160px] rounded-xl p-3 text-left opacity-70" style={{ animationDelay: '-4s' }}>
          <div className="mb-2 flex gap-1.5">
            <span className="h-2 w-2 rounded-full bg-rose-400/80" />
            <span className="h-2 w-2 rounded-full bg-amber-400/80" />
            <span className="h-2 w-2 rounded-full bg-emerald-400/80" />
          </div>
          <pre className="font-mono text-[10px] leading-relaxed text-indigo-200/90">{`deploy:\n  env: prod\n  status: ✓`}</pre>
        </div>
      </div>

      <div className="perspective-scene relative z-10 mx-auto w-full max-w-[90vw] sm:max-w-2xl md:max-w-3xl lg:max-w-4xl xl:max-w-5xl text-center px-4 sm:px-6">
        ...
        <div className="mt-7 sm:mt-8 lg:mt-10 flex justify-center">
          <motion.a
            ...
            className="lift-hover inline-flex items-center gap-2 rounded-xl px-5 py-3 sm:px-7 sm:py-3.5 text-base sm:text-lg text-white bg-gradient-to-r from-violet-600 via-fuchsia-500 to-cyan-400 hover:from-violet-700 hover:via-fuchsia-600 hover:to-cyan-500 active:translate-y-[1px] ring-1 ring-violet-400/30 hover:ring-violet-400/50 shadow-lg hover:shadow-violet-500/20"
        ...
        <div className="mt-6 sm:mt-8 flex flex-col items-center justify-center gap-3 text-slate-400 pb-8 sm:pb-12 lg:pb-16">
          ...
          <div className="flex items-center gap-2">
            <a aria-label="GitHub" href="https://github.com/JBTech-git" target="_blank" rel="noreferrer noopener" className="lift-hover group inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/10 bg-gradient-to-r from-violet-500/20 to-cyan-400/20 shadow-sm hover:from-violet-500/30 hover:to-cyan-400/30">
            ...
            <a aria-label="LinkedIn" href="https://www.linkedin.com/in/jayanta-barman-747298211" target="_blank" rel="noreferrer noopener" className="lift-hover group inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/10 bg-gradient-to-r from-violet-500/20 to-cyan-400/20 shadow-sm hover:from-violet-500/30 hover:to-cyan-400/30">
            ...
            <a aria-label="WhatsApp" href="https://wa.me/918388988586" target="_blank" rel="noreferrer noopener" className="lift-hover group inline-flex h-9 w-9 items-center justify-center rounded-full border border-white/10 bg-gradient-to-r from-violet-500/20 to-cyan-400/20 shadow-sm hover:from-violet-500/30 hover:to-cyan-400/30">
...
function Projects() {
  ...
  return (
    <Section id="projects" className="relative">
      ...
      <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 perspective-scene">
        {items.map((p, i) => (
          <TiltCard
            key={p.title}
            as="button"
            ...
            onClick={() => setOpen(p)}
            maxTilt={9}
            className="cursor-pointer text-left group relative overflow-hidden rounded-2xl border border-white/10 bg-white/10 backdrop-blur-md p-4 ring-1 ring-white/10 shadow-[0_18px_50px_-22px_rgba(2,6,23,0.75)] hover:ring-white/20 focus:outline-none focus:ring-2 focus:ring-cyan-300/50 w-full"
          >
            <div
...
function About() {
  ...
  return (
    <Section id="about" className="relative overflow-hidden bg-gradient-to-b from-indigo-950 via-slate-950 to-blue-950">
      ...
      <div className="mt-10 grid gap-8 md:grid-cols-2 md:items-center perspective-scene">
        <div className="justify-self-center w-full max-w-[280px] sm:max-w-[320px] mx-auto">
          <TiltCard className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-[0_20px_50px_-24px_rgba(56,189,248,0.35)] ring-1 ring-white/10" maxTilt={8}>
        ...
        <div>
          ...
          <div className="mt-8 grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              ...
              <TiltCard key={label} maxTilt={6} className="flex flex-col justify-center items-center text-center gap-2 sm:gap-3 rounded-xl border border-white/10 bg-white/5 px-3 py-3 sm:px-4 text-slate-200 glass-panel">
        ...
        {[
          ...
          <TiltCard key={k} maxTilt={5} className="text-center rounded-xl border border-white/10 bg-white/5 px-3 py-4 glass-panel">
            <div
...
function Skills() {
  ...
  return (
    <Section id="skills" className="pt-12">
      ...
      <div className="perspective-scene mt-6 sm:mt-8">
      <TiltCard
        maxTilt={4}
        className="relative overflow-hidden rounded-2xl sm:rounded-3xl border border-white/10 bg-white/10 backdrop-blur-md shadow-[0_20px_60px_-24px_rgba(2,6,23,0.65)] p-4 sm:p-6 md:p-8 ring-1 ring-white/10"
      >
        <div
